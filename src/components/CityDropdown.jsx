  ...
  return (
    <div className="w-full max-w-xs mx-auto mt-2 flex flex-col items-center">
      <div className="relative w-full">
        ...
        <svg className="pointer-events-none absolute right-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-black" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" /></svg>
      </div>
    </div>
  );
};
