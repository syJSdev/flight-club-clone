...
const Header = () => {
  ...
  <header className="w-full bg-black text-white px-8 py-3 flex items-center justify-between font-sans">
    <nav className="fixed top-0 left-0 right-0 z-40 bg-black">
      <div className="relative z-20 max-w-lg mx-auto w-full lg:max-w-xl flex items-center">
        <div className="px-4 py-3 hidden lg:flex">
          <a className="block" href="#">
            <img
              src="https://www.flightclubdartsusa.com/img/logo-white.png"
              className="block h-8"
            />
          </a>
        </div>
          ...
          <div className="flex items-center justify-center">
            <div className="mx-2 px-4">
              <a
                ...
                href="#"
              >
                <span className="flex-shrink-0 italic">locations &nbsp;</span>
        ...
        <div
          id="navMobileActions"
          className="lg:hidden w-full flex justify-between py-2"
        >
      ...
      >
        <div className="wrap-lg lg:wrap-xl flex flex-row justify-center">
            ...
            <div className="flex items-center">
              <div className="px-4">
                <a
                  ...
                  className="font-serif text-1250 hover:text-red transition-all"
                >
                  Atlanta
                </a>
              </div>
      ...
      >
        <div className="wrap-lg lg:wrap-xl flex items-center py-8">
          <div className="flex pl-[8.5rem]">
            ...
            >
              <div className="relative px-4">
                <a
                  ...
                  className="font-serif text-1250 text-white hover:text-red transition-all"
                >
                  Atlanta
                </a>
              </div>
            ...
            <div className="text-white pl-16 ml-16 w-64 border-l border-white">
              ...
              >
                <button
                  x-on:click="country = 'usa'"
                  className="font-serif text-1250 text-white hover:text-red transition-all"
                >
                  FC USA
                </button>
              </div>
              <div className="px-4 mb-4" x-show="country != 'uk'">
                <button
                  x-on:click="country = 'uk'"
                  className="font-serif text-1250 text-white hover:text-red transition-all"
                >
                  FC UK
                </button>
              </div>
              <div className="px-4 mb-4" x-show="country != 'australia'">
                <button
                  x-on:click="country = 'australia'"
                  className="font-serif text-1250 text-white hover:text-red transition-all"
                >
                  FC Australia
                </button>
      ...
      <div
        x-show="open"
        className="flex flex-col lg:hidden items-center justify-center fixed inset-0 z-10 bg-black pointer-events-auto overflow-hidden"
      ...
      >
        ...
        <div
          x-show="!mobileLocations"
          className="w-full max-w-screen-xl mx-auto px-4 text-white"
        >
          <div className="py-4 uppercase text-center hover:text-red transition-all">
            <a
              className="cursor-pointer"
              href="#"
              x-on:click="mobileLocations = true"
            >
              Locations
            </a>
          </div>
        ...
        >
          <div className="py-4 uppercase text-center hover:text-red transition-all">
            <button x-on:click="mobileLocations = false">&lt; Back</button>
          </div>
          <div className="flex flex-col mt-4">
            ...
            >
              ...
              <div className="relative px-4">
                ...
                <div className="italic text-white text-[.75rem] opacity-50">
                  Coming soon...
                </div>
              </div>
            ...
            <div
              className="grid grid-rows-1 gap-4 text-center"
              x-show="country == 'uk'"
